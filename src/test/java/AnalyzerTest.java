...
public class AnalyzerTest {
    ...
    * Método readFile de la clase Analyzer
    ...
    // Test existencia de Texto
    @Test
    public void test_readFile_FileExist() {
        List<Sentence> list = new ArrayList<Sentence>();
        list = Analyzer.readFile("texto.txt");
    ...
    // Test en caso que este vacio el archivo texto pueda devolver una lista vacia
    @Test
    public void test_readFile_ReadFileEmpty() {
        List<Sentence> ListEmpty = Analyzer.readFile("textovacio.txt");
        assertEquals("", 0, ListEmpty.size());
    }

    /*
    * Test verifica en caso de existir filas que no cumplan el formato correcto no lea del archivo
     */
    @Test
    public void test_readFile_NotReadIncorrectFormat() {
        List<Sentence> listIncorrectFormat = Analyzer.readFile("textoprueba.txt");
    ...
    public void test_readFile_ReadCorrectFormat() {
        List<Sentence> listCorrectFormat = Analyzer.readFile("texto.txt");
    ...
    */
    ...
    public void test_readFile_OutLimits() {
        List<Sentence> list = Analyzer.readFile("condicionante.txt");
